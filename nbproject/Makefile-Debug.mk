...
LDLIBSOPTIONS=-ldibcomcontrol -lgpioctrl -ltsi -lucsi `pkg-config --libs gstreamer-0.10` -liconv -lgstbase-0.10 -lgstapp-0.10 -lid3tag  
...
.build-conf: ${BUILD_SUBPROJECTS} nbproject/qt-${CND_CONF}.mk
	"${MAKE}" -f nbproject/qt-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tv_player
