...
#define GST_QUEUE(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_QUEUE,GstQueue3))
#define GST_QUEUE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_QUEUE,GstQueue3Class))
...
struct _GstQueueClass {
  ...
  void (*underrun)      (GstQueue3 *queue);
  void (*running)       (GstQueue3 *queue);
  void (*overrun)       (GstQueue3 *queue);

  void (*pushing)       (GstQueue3 *queue);
};
