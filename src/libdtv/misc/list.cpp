 ...
 * @return 
 */
uint8_t list::add_to_list(void *data)
{
 ...
 * @return      
 */
void * list::get_from_list(uint16_t pos)
{
 ...
 */
uint32_t list::get_list_count(void)
{
#if 0
    list_node_t *temp = NULL;
    uint16_t i = 0;
 ...
 */
int32_t list::get_list_max_idx(void)
{
 ...
 * @param pos
 */
void list::remove_nth_node(uint16_t pos)
{
    list_node_t *temp = NULL;
